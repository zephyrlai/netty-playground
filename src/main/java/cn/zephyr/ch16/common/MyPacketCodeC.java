...
import cn.zephyr.ch8.Serializer;
...
public class MyPacketCodeC {
    ...
    private static class SingleHandler{
        private static MyPacketCodeC INSTANCE = new MyPacketCodeC(SerializerEnum.JSON_SERIALIZER);
    }

    public static MyPacketCodeC getInstance(){
    ...
    public MyPacketCodeC(SerializerEnum... serializerEnums) {
    ...
    public void encode(ByteBuf byteBuf,Packet packet, Byte serializeAlg){
        // 创建 ByteBuf 容器
//        ByteBuf byteBuf = ByteBufAllocator.DEFAULT.ioBuffer();
    ...
    public Packet decode(ByteBuf byteBuf){
        ...
        // 解析指令对应的反序列化类型
        MyCommandEnum commandEnum = MyCommandEnum.getCommandEnum(command);
        if (commandEnum == null) {
